 ...
 * Security release with updated version of Olm to fix https://nobody.network/blog/2021/12/03/pre-disclosure-upcoming-security-release-of-libolm-and-matrix-js-sdk
...
## 🔒 SECURITY FIXES
 * Fix a security issue with message key sharing. See https://nobody.network/blog/2021/09/13/vulnerability-disclosure-key-sharing
   for details.
 ...
 * Update riot.im enable_presence_by_hs_url for new nobody.network client URL
 ...
 * Update sample config for new nobody.network CS API URL
 ...
 * Use packages.nobody.network for Olm
 ...
 * Don't show custom server bit on nobody.network
 ...
 * Don't show presence on nobody.network
